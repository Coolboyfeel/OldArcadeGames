...
public class InvaderSpawnerSpaceInvaders : MonoBehaviour
{
	public float offsetMover;

    public InvaderSpaceInvaders[] prefabs;
    ...
    void Awake() 
    {
        for(int row = 0; row < this.rows; row++) 
        {
            ...
            {
                InvaderSpaceInvaders invader = Instantiate(this.prefabs[row], this.transform);
